              ...
              <li key={cat.id} className="px-5 py-3">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <button
                    ...
                    className="px-3 py-1 text-xs text-red-600 border border-red-200 rounded-lg hover:bg-red-50 transition disabled:opacity-30 disabled:cursor-not-allowed shrink-0"
                  >
                    削除
                  </button>
                </div>
