...
export const journeyEntries: JourneyEntry[] = [
  ...
  },
  {
    ...
    period: "2017〜2023",
    description:
      "「久しぶりに経済学の本読んだけど、やっぱ苦手」と言いつつも、金融政策、自由貿易、マーケティングなど折に触れて手を伸ばしてきた。特に有斐閣の教科書は信頼している。起業やプロダクトマネジメントにも関心が広がっている。",
    books: [
  ...
  },
  {
    ...
    period: "2023",
    description:
      "コンピュータの仕組みを基礎から学び、プログラミングの原則を学んだ。この読書記録アプリ自体が、本を読むだけでなくコードを書く人間になった証でもある。",
    books: [
